...
// //global variable for snake's position 
// extern int g_snake_position;
// //global variable,an enum, for snake's direction 
...
typedef struct snake {
    //an enum for the snake's direction 
    enum input_key snake_direction;
    //linked list for snake's position 
